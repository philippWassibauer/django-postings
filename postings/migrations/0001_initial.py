...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PostingWall'
        db.create_table('postings_postingwall', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('postings', ['PostingWall'])

        # Adding model 'Posting'
        db.create_table('postings_posting', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('posting_wall', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['postings.PostingWall'])),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='postings', to=orm['auth.User'])),
            ('body', self.gf('django.db.models.fields.TextField')()),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal('postings', ['Posting'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'PostingWall'
        db.delete_table('postings_postingwall')

        # Deleting model 'Posting'
        db.delete_table('postings_posting')
    ...
    models = {
        ...
        'postings.imageattachment': {
            ...
            'posting': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['postings.Posting']"}),
            'source': ('django.db.models.fields.CharField', [], {'default': "'UPLOAD'", 'max_length': '40'})
        },
        'postings.linkattachment': {
            'Meta': {'object_name': 'LinkAttachment'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link': ('django.db.models.fields.CharField', [], {'max_length': '400'}),
            'link_description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'link_title': ('django.db.models.fields.CharField', [], {'max_length': '400', 'null': 'True', 'blank': 'True'}),
            'posting': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['postings.Posting']"})
        },
        'postings.posting': {
